...
Every pass also logs the gi blend composition ("gi blend: fng 37.00 -> 2.32% (w 0.50) | range 2.32% (w 0.25) | survival 5.00% (w 0.25) -> resolved 5.00% (blend 2.99% clamped: survival binds)") and the qty blend ("qty blend: floor 0.15 -> resolved 0.15 (fng 37.00, k 0.63; no headroom: F&G qty contribution 0)") so the weighting and any clamp-away of sentiment is visible, not silent.
