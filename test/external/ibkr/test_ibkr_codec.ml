...
let test_encode_fields_multiple () =
  ...
  let len =
    ...
    lor (Bytes.get_uint8 result 2 lsl 8)
    lor Bytes.get_uint8 result 3
  in
...
let test_encode_fields_empty_list () =
  ...
  Alcotest.(check int) "empty list length prefix" 1 (Bytes.get_uint8 result 3)
;;
...
let test_encode_handshake () =
  ...
  let len_from_prefix =
    (Bytes.get_uint8 result 4 lsl 24)
    lor (Bytes.get_uint8 result 5 lsl 16)
    lor (Bytes.get_uint8 result 6 lsl 8)
    lor Bytes.get_uint8 result 7
  in
  ...
  Alcotest.run
    ...
    [ ( "encoding"
      , [ Alcotest.test_case "encode_fields_single" `Quick test_encode_fields_single
        ...
        ; Alcotest.test_case
            "encode_fields_empty_list"
            `Quick
            test_encode_fields_empty_list
        ; Alcotest.test_case
            "encode_fields_empty_strings"
            `Quick
            test_encode_fields_empty_strings
    ...
    ; ( "decoding"
      , [ Alcotest.test_case "decode_fields_basic" `Quick test_decode_fields_basic
        ...
        ; Alcotest.test_case
            "decode_fields_empty_payload"
            `Quick
            test_decode_fields_empty_payload
        ; Alcotest.test_case
            "decode_fields_empty_fields"
            `Quick
            test_decode_fields_empty_fields
        ] )
    ; ( "roundtrip"
