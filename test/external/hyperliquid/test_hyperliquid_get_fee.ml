let test_parse_fee_info_valid () =
  let json_str =
    {|{"userAddRate":"0.0001","userCrossRate":"0.0003","userSpotAddRate":"0.00028","userSpotCrossRate":"0.00049"}|}
  in
...
let test_parse_fee_info_zero_rates () =
  let json_str =
    {|{"userAddRate":"0.0","userCrossRate":"0.0","userSpotAddRate":"0.0","userSpotCrossRate":"0.0"}|}
  in
  match Hyperliquid.Get_fee.parse_fee_info json_str with
  | Some info ->
